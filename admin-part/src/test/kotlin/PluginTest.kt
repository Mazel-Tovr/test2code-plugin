...
private val storageDir = File("build/tmp/test/storages/PluginTest-${UUID.randomUUID()}")
...
//        addProbes(plugin, sessionId, countAddProbes = 10, sizeExec = 100, sizeProbes = 10_000)//completed
    ...
    println("WE done ${finishedSession?.id}")
    //TODO need init CoverContext
