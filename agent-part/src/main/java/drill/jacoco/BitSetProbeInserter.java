...
/**
 * It is based on {@link ProbeInserter}, but use bitSet.
 * Internal utility to add probes into the control flow of a method. The code
 * for a probe simply sets a certain slot of a bitSet to true. In
...
public class BitSetProbeInserter extends MethodVisitor {
     ...
     *                      the probe array
     */
    public BitSetProbeInserter(final int access, final String name, final String desc,
